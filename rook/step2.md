Deploy the Rook operator: `kubectl apply -f $HOME/rook/cluster/examples/kubernetes/ceph/operator.yaml`{{execute}}
...
Create the Rook cluster: `kubectl apply -f $HOME/rook/cluster/examples/kubernetes/ceph/cluster.yaml`{{execute}}
